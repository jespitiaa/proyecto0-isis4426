    ...
    render(){
        ...
        <Form onSubmit={this.handleSubmit}>
            <Form.Group controlId="formBasicName">
                ...
                <Form.Control type="text" value={this.state.event_name} onChange={(event)=>this.setState({event_name:event.target.value})} />
            </Form.Group>
            ...
            <Form.Group controlId="formBasicPlace">
                ...
                <Form.Control type="text" value={this.state.event_place} onChange={(event)=>this.setState({event_place:event.target.value})} />
            </Form.Group>
            
            <Form.Group controlId="formBasicAddress">
                <Form.Label>Dirección del lugar del evento</Form.Label>
                <Form.Control type="text" value={this.state.event_address} onChange={(event)=>this.setState({event_address:event.target.value})} />
            </Form.Group>
            
            <Form.Group controlId="formBasicInitDate">
                <Form.Label>Fecha de inicio del evento</Form.Label>
                <Form.Control type="text" value={this.state.event_initial_date} onChange={(event)=>this.setState({event_initial_date:event.target.value})} />
            </Form.Group>
            
            <Form.Group controlId="formBasicFinalDate">
                <Form.Label>Fecha de fin del evento</Form.Label>
                <Form.Control type="text" value={this.state.event_final_date} onChange={(event)=>this.setState({event_final_date:event.target.value})} />
            </Form.Group>
